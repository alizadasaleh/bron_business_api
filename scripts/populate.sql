...
INSERT INTO addresses (latitude, longitude, postal_code, city, state, street) VALUES
                                                                                  (40.7128, -74.0060, '10007', 'New York', 'NY', '123 Broadway'),
...
INSERT INTO contacts (phone_number, email, website, additional_phone_number, additional_email, schedule, address_id) VALUES
                                                                                                                         ('123-456-7890', 'contact1@example.com', 'http://contact1.com', '321-654-0987', 'additional1@example.com',
...
COMMIT ;
INSERT INTO companies (name, description, contact_id) VALUES
                                                          ('Company A', 'Description for Company A', 1),
...
COMMIT ;
INSERT INTO services (name, description, duration, company_id) VALUES
                                                                   ('Service 1', 'Description for Service 1', '{"hours":1,"minutes":30}', 1),
