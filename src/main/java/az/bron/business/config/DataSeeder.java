...
//
//            // Define companies
//            Company company1 = createCompany("Tech Innovations Inc.", "A leading tech company specializing in innovative solutions.", "555-1234", "info@techinnovations.com", "https://www.techinnovations.com",
//            "555-5678", "support@techinnovations.com", commonSchedule, 37.7749, -122.4194, "94103", "San
//            Francisco", "CA", "123 Market St");
//
//            Company company2 = createCompany("Green Energy Solutions", "Innovative solutions for a sustainable future.", "555-2345", "contact@greenenergy.com", "https://www.greenenergy.com",
//            "555-6789", "support@greenenergy.com", commonSchedule, 34.0522, -118.2437, "90001", "Los Angeles",
//            "CA", "456 Elm St");
//
//            Company company3 = createCompany("HealthTech Labs", "Cutting-edge health technology and research.", "555-3456", "info@healthtechlabs.com", "https://www.healthtechlabs.com",
//            "555-7890", "support@healthtechlabs.com", commonSchedule, 40.7128, -74.0060, "10001", "New York", "NY",
//            "789 Broadway");
//
//            Company company4 = createCompany("FinTech Experts", "Revolutionizing finance with technology.", "555-4567", "contact@fintexperts.com", "https://www.fintexperts.com",
//            "555-8901", "support@fintexperts.com", commonSchedule, 41.8781, -87.6298, "60601", "Chicago", "IL",
//            "101 State St");
//
//            Company company5 = createCompany("EduTech Innovations", "Transforming education through technology.", "555-5678", "info@edutechinnovations.com", "https://www.edutechinnovations.com",
//            "555-9012", "support@edutechinnovations.com", commonSchedule, 47.6062, -122.3321, "98101", "Seattle",
//            "WA", "202 Pine St");
//
...
//            ProvidedService svc1 = new ProvidedService(null, "Tech Consulting", "Expert tech consulting services.",
//            Duration.builder().hours(4).build(), company1, cat1, null);
//            ProvidedService svc2 = new ProvidedService(null, "App Development", "Custom app development services.",
//            Duration.builder().hours(2).build(), company1, cat2, null);
//            ProvidedService svc3 = new ProvidedService(null, "Technical Support", "24/7 technical support.",
//            Duration.builder().hours(1).build(), company1, cat3, null);
//            ProvidedService svc4 = new ProvidedService(null, "UI/UX Design", "Design services for user interfaces
//            and experiences.", Duration.builder().hours(3).build(), company1, cat4, null);
//            ProvidedService svc5 = new ProvidedService(null, "Training Workshop", "Hands-on training workshops.",
//            Duration.builder().hours(1).build(), company1, cat5, null);
//
////            ProvidedService svc1 = new ProvidedService(null, "Tech Consulting", "Expert tech consulting services
// .", Duration.builder().hours(4).build(), company3, cat1, null);
////            ProvidedService svc2 = new ProvidedService(null, "App Development", "Custom app development services
// .", Duration.builder().hours(2).build(), company3, cat2, null);
////            ProvidedService svc3 = new ProvidedService(null, "Technical Support", "24/7 technical support.",
// Duration.builder().hours(1).build(), company3, cat3, null);
////            ProvidedService svc4 = new ProvidedService(null, "UI/UX Design", "Design services for user interfaces
// and experiences.", Duration.builder().hours(3).build(), company3, cat4, null);
////            ProvidedService svc5 = new ProvidedService(null, "Training Workshop", "Hands-on training workshops.",
// Duration.builder().hours(1).build(), company3, cat5, null);
...
//    }
//
//    private Company createCompany(String name, String description, String phoneNumber, String email, String
//    website, String additionalPhoneNumber, String additionalEmail, Schedule schedule, Double latitude, Double
//    longitude, String postalCode, String city, String state, String street) {
