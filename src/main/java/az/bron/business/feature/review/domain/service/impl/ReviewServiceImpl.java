...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public Optional<Review> getReviewByAppointmentIdAndUserId(Long appointmentId, Long userId) {
        return reviewRepository.getByAppointmentIdAndUserId(appointmentId,userId);
    }
}
