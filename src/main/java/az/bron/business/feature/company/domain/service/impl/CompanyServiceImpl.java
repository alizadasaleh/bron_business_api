...
public class CompanyServiceImpl implements CompanyService {
    ...
    @Override
    public SearchResult<CompanyWithDistance> search(CompanySearchFilter companySearchFilter, int page, int size) {
        return companySearchRepository.searchCompanies(companySearchFilter, page, size);
    }
